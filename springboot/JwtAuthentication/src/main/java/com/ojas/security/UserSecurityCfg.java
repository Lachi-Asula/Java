...
import com.ojas.jwt.InvalidAuthenticationEntryPoint;

@Configuration
@EnableWebSecurity
public class UserSecurityCfg extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private SecurityFilter secureFilter;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.userDetailsService(userDetailesService).passwordEncoder(encoder);
	}
