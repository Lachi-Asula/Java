...
public class FlamesService {
    ...
    public CommonResponse getRelationType(String request){
        ...
        try{
            ...
            UserDTO userDTO = mapper.readValue(request, UserDTO.class);
            if(userDTO != null && userDTO.getFirstName() != null && userDTO.getSecondName() != null) {
                ...
                relationDTO = RelationDTO.builder()
                        ...
                        .errorMsg(null)
                        .build();
                commonResponse.setIsSuccessful(true);
            }else {
                relationDTO = RelationDTO.builder()
                        .relation(null)
