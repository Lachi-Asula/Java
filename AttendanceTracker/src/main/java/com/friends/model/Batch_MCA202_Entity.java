...
@Entity
@Table(name = "TBL_AUDIT_MCA202")
@Data
@Builder
public class Batch_MCA202_Entity {

    @Column(name = "FLD_CREATED_DATE", insertable = false, updatable = false)
    private String timeStampValue;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "batch02")
    @SequenceGenerator(allocationSize = 1, name = "batch02")
    @Column(name = "FLD_ID")
    private int id;
    ...
    public Batch_MCA202_Entity() {
    }

    public Batch_MCA202_Entity(String timeStampValue, int id, String fldEmpId, String fldFullName, String fldStaffName, String fldYear, String fldMonth, String fldStatus) {
